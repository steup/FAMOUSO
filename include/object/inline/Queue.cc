inline Chain* Queue::ending () const { return tail; }

inline void Queue::ending (const Chain& item) { tail = (Chain*)&item; }

inline void Queue::adjust () { ending(*(Chain*)this); }

inline Queue::Queue () : Stack() { adjust(); }
